...
if ($_SERVER['REQUEST_METHOD'] == 'POST' &&  isset($_POST['PUT'])) {
    ...
    $_SESSION['Post-edited'] = 'Post edited';
...
<div class="container py-4">
    <header class="pb-3 mb-4 border-bottom">
        <a href="" class="d-flex align-items-center text-body-emphasis te xt-decoration-none">
            ...
            <span class="fs-4">Editing a post</span>
        </a>
    </header>

    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
        <form method="POST" class="container-fluid py-5">
